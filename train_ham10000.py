...
if __name__ == '__main__':
    ...
    args.dataset = 'ham10000'
    args.data_root = 'FSL_Data/ham10000'
    args.base_model = 'resnet18'
    args.device = 'cuda' if torch.cuda.is_available() else 'cpu'
    args.num_classes = 7  # HAM10000 has 7 classes
    args.lr = 0.001
    args.lr_drop = 20
    args.epochs = 50
    args.batch_size = 16
    ...
    model_name = f"{args.dataset}_{args.base_model}_{'use_slot_' if args.use_slot else 'no_slot_'}checkpoint.pth"
